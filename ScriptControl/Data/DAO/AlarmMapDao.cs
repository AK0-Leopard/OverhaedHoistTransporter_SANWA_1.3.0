...
namespace com.mirle.ibg3k0.sc.Data.DAO
{
    ...
    public class AlarmMapDao : DaoBase
    {
            ...
            try
            {
                ...
                var query = from c in dt.AsEnumerable()
                            select new AlarmMap
                            {
                                ...
                                ALARM_DESC_CH = c.Field<string>("ALARM_DESC_CH"),
        ...
        public AlarmMap getAlarmMap(SCApplication scApp, string object_id, string alarm_id)
        {
            try
            {
                DataTable dt = scApp.OHxCConfig.Tables["ALARMMAP"];
                var query = from c in dt.AsEnumerable()
                            where c.Field<string>("OBJECT_ID").Trim() == object_id.Trim() &&
