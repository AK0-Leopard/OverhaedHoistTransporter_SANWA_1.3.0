...
{
    public class MTSValueDefMapAction : IValueDefMapAction
    {
        public const string DEVICE_NAME_MTL = "MTL";
        Logger logger = NLog.LogManager.GetCurrentClassLogger();
        MaintainSpace eqpt = null;
        protected SCApplication scApp = null;
        protected BCFApplication bcfApp = null;

        public MTSValueDefMapAction()
            : base()
        {
        ...
        public virtual void MTL_CarInRequest(object sender, ValueChangedEventArgs args)
        {
            ...
            try
            {
                ...
                {
                    MaintainLift mtl = scApp.EquipmentBLL.cache.GetMaintainLift();
                    var check_result = scApp.MTLService.checkVhAndMTxCarInStatus(eqpt, mtl, pre_car_in_vh);
                ...
                {
                    scApp.MTLService.processCarInScenario(eqpt);
                }
